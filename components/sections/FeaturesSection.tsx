        ...
        >
            ...
            <div className="container-custom">
                ...
                <SectionHeader
                    ...
                    title="Dirancang untuk memandu"
                    gradient="perjalanan karir Anda"
                    description="
                        SkillMatch AI menggabungkan analisis profil cerdas, pemetaan kesesuaian keterampilan, 
                        serta rekomendasi peta jalan pembelajaran (learning path) ke dalam satu platform modern 
                        yang dibangun khusus untuk mahasiswa dan profesional.
                    "
                />
